...
class FIFODeliveryCalculator(BaseDeliveryCalculator):
    ...
    def calculate_delivery_time(self, req_prods, *sim_warehouses):

        for warehouse in sim_warehouses:
            count_warehouse_in_arrival_time = False

            for prod_to_deliv in req_prods:
                ...
                if prod_to_deliv._id in warehouse['inventory']:
                    ...
                    if prod_to_deliv.stock_requested <= \
                            warehouse['inventory'][prod_to_deliv._id]:
                        warehouse['inventory'][prod_to_deliv._id] -= \
                            prod_to_deliv.stock_requested
